...
function routes(app) {
	...
	if (landmark.get('cloudinary config')) {
		app.get('/landmark/api/cloudinary/get', require('../../routes/api/cloudinary').get);
		app.get('/landmark/api/cloudinary/autocomplete', require('../../routes/api/cloudinary').autocomplete);
	}
