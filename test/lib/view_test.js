var demand = require('must'),
	...
	landmark = require('../../index.js');

var getApp = function() {
	var app = landmark.express();
	app.use(landmark.express.bodyParser());
	app.use(landmark.express.methodOverride());
	return app;
}

describe('Landmark.View', function() {
	...
	describe('new', function() {
		it('must be an instance of View', function(done) {
			...
			app.get('/', function(req, res) {
				...
				view.must.be.an.instanceof(landmark.View);
				res.send('OK');
			});
			request(app)
				.get('/')
