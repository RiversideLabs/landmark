/**
 * This script builds the LandmarkJS Docs website to a directory.
 * 
 ...
 * 
 * e.g.
 * 		node build /Users/mike/Development/Projects/Landmark-Docs
 */
...
console.log('\nLandmarkJS docs built to ' + path.resolve(args.dest) + '\n');
process.exit();
